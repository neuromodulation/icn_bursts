...
# Comparison: Beta power vs burst length 
## Beta power vs burst length (Pandas)
...
## Plot beta power vs burst length
...
## M1 normalized power OFF vs ON (Pandas)
...
## Probability of different burst length OFF vs ON (Pandas)
...
## M1 burst length OFF vs ON (Pandas)
...
## Plot Biomarker (beta power vs burst length) comparison
