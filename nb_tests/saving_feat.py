...
def save_npow(power_spectra_norm):
...
def save_burst_dynamics(norm_histogram_duration):
    '''
    save Probability of M1 Burst Duration in Pandas
    '''
